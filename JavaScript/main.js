!(function (e, t) {
  ...
  function p(e) {
    return e.replace(Ce, "ms-").replace(Ae, d);
  }
  function g() {
  ...
  function v(e, t, n) {
    ...
    if (void 0 === n && 1 === e.nodeType)
      if (
        ((i = "data-" + t.replace(Ie, "-$&").toLowerCase()),
  ...
  function b(e, t) {
    for (var n, i, r = [], o = 0, s = e.length; o < s; o++)
      (i = e[o]).style &&
        ...
        t
          ? ("none" === n &&
              ((r[o] = De.get(i, "display") || null),
              r[o] || (i.style.display = "")),
            "" === i.style.display && Pe(i) && (r[o] = _(i)))
          : "none" !== n && ((r[o] = "none"), De.set(i, "display", n)));
    ...
    return (
      (n =
        void 0 !== e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && o(e, t)) ? ue.merge([e], n) : n
    );
  }
  function T(e, t) {
  ...
  function w(e, t, n, r, o) {
    for (
      ...
      if ((s = e[p]) || 0 === s)
        if ("object" === i(s)) ue.merge(d, s.nodeType ? [s] : s);
        else if (Fe.test(s)) {
          for (
            a = a || h.appendChild(t.createElement("div")),
              l = (We.exec(s) || ["", ""])[1].toLowerCase(),
              u = Be[l] || Be._default,
              a.innerHTML = u[1] + ue.htmlPrefilter(s) + u[2],
              f = u[0];
            f--;

          )
            a = a.lastChild;
          ue.merge(d, a.childNodes), ((a = h.firstChild).textContent = "");
        } else d.push(t.createTextNode(s));
    for (h.textContent = "", p = 0; (s = d[p++]); )
      if (r && ue.inArray(s, r) > -1) o && o.push(s);
      else if (
        ((c = ue.contains(s.ownerDocument, s)),
        (a = E(h.appendChild(s), "script")),
        c && T(a),
        n)
      )
        for (f = 0; (s = a[f++]); ) Me.test(s.type || "") && n.push(s);
    return h;
  }
  function C() {
    return !0;
  ...
  function O(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        De.hasData(e) &&
        ((o = De.access(e)), (s = De.set(t, o)), (u = o.events))
      ) {
        delete s.handle, (s.events = {});
        for (r in u)
          for (n = 0, i = u[r].length; n < i; n++) ue.event.add(t, r, u[r][n]);
      }
      Se.hasData(e) &&
        ((a = Se.access(e)), (l = ue.extend({}, a)), Se.set(t, l));
    }
  }
  function k(e, t) {
  ...
  function L(e, t, i, r) {
    ...
    var o,
      ...
      p = t[0],
      g = oe(p);
    if (g || (h > 1 && "string" == typeof p && !re.checkClone && $e.test(p)))
    ...
    if (
      ...
      for (l = (a = ue.map(E(o, "script"), N)).length; f < h; f++)
        (u = o),
          f !== d &&
            ((u = ue.clone(u, !0, !0)), l && ue.merge(a, E(u, "script"))),
          i.call(e[f], u, f);
      if (l)
        for (c = a[a.length - 1].ownerDocument, ue.map(a, I), f = 0; f < l; f++)
          (u = a[f]),
            Me.test(u.type || "") &&
              !De.access(u, "globalEval") &&
              ue.contains(c, u) &&
              (u.src && "module" !== (u.type || "").toLowerCase()
                ? ue._evalUrl && ue._evalUrl(u.src)
                : n(u.textContent.replace(Ge, ""), c, u));
    }
    return e;
  }
  function P(e, t, n) {
    for (var i, r = t ? ue.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || ue.cleanData(E(i)),
        i.parentNode &&
          (n && ue.contains(i.ownerDocument, i) && T(E(i, "script")),
  ...
  function B(e, t, n, i, r, o) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += ue.css(e, n + Le[s], !0, r)),
        i
          ? ("content" === n && (l -= ue.css(e, "padding" + Le[s], !0, r)),
            "margin" !== n &&
              (l -= ue.css(e, "border" + Le[s] + "Width", !0, r)))
          : ((l += ue.css(e, "padding" + Le[s], !0, r)),
            "padding" !== n
              ? (l += ue.css(e, "border" + Le[s] + "Width", !0, r))
              : (a += ue.css(e, "border" + Le[s] + "Width", !0, r)));
    return (
      !i &&
        o >= 0 &&
        (l += Math.max(
  ...
  function F(e, t, n) {
    ...
    return (
      (s = s && (re.boxSizingReliable() || r === e.style[t])),
      ("auto" === r ||
        (!parseFloat(r) && "inline" === ue.css(e, "display", !1, i))) &&
        ((r = e["offset" + t[0].toUpperCase() + t.slice(1)]), (s = !0)),
      (r = parseFloat(r) || 0) +
        B(e, t, n || (o ? "border" : "content"), s, i, r) +
        "px"
    );
  }
  function U(e) {
  ...
  (ue.fn = ue.prototype = {
      ...
      for (
        ...
        if (null != (e = arguments[a]))
          for (t in e)
            (n = s[t]),
              s !== (i = e[t]) &&
                (u && i && (ue.isPlainObject(i) || (r = Array.isArray(i)))
                  ? (r
    ...
    "function" == typeof Symbol &&
      (ue.fn[Symbol.iterator] = Q[Symbol.iterator]),
    ue.each(
  ...
  var fe = (function (e) {
    function t(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : M) !== O && I(t), (t = t || O), L)
      ) {
        if (11 !== p && (l = ge.exec(e)))
          if ((r = l[1])) {
            if (9 === p) {
      ...
      return (
        ...
        i(function (i, s, a, l) {
          var u,
            ...
            _ = n ? (o || (i ? e : m || r) ? [] : s) : y;
          if ((n && n(y, _, a, l), r))
            for (u = g(_, d), r(u, [], a, l), c = u.length; c--; )
              (f = u[c]) && (_[d[c]] = !(y[d[c]] = f));
          if (i) {
            if (o || e) {
              if (o) {
    ...
    function v(e) {
      for (
        ...
        if ((n = E.relative[e[a].type])) c = [h(d(c), n)];
        else {
      ...
      var r = n.length > 0,
        ...
        s = function (i, s, a, l, u) {
          ...
          for (
            ...
            if (o && c) {
              for (
                f = 0, s || c.ownerDocument === O || (I(c), (a = !L));
                (h = e[f++]);
          ...
          if (((d += p), r && p !== d)) {
            ...
            if (i) {
              if (d > 0) for (; p--; ) m[p] || v[p] || (v[p] = $.call(l));
              v = g(v);
            }
            z.apply(l, v),
    ...
    try {
      z.apply((Y = X.call(M.childNodes)), M.childNodes),
    ...
    (b = t.support = {}),
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!b.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === O || (e.ownerDocument === M && R(M, e))
                        ? -1
                        : t === O || (t.ownerDocument === M && R(M, t))
                        ? 1
                        : S
                        ? J(S, e) - J(S, t)
                        : 0
      ...
      (t.attr = function (e, t) {
        ...
        var n = E.attrHandle[t.toLowerCase()],
          i = n && Q.call(E.attrHandle, t.toLowerCase()) ? n(e, t, !L) : void 0;
        return void 0 !== i
          ? i
          : b.attributes || !L
          ? e.getAttribute(t)
                    ...
                    if (((p = [s ? m.firstChild : m.lastChild]), s && y)) {
                      ...
                      (y &&
                        (_ = d =
                          (u =
                            (c =
                              (f = (h = t)[W] || (h[W] = {}))[h.uniqueID] ||
                              (f[h.uniqueID] = {}))[e] || [])[0] === B && u[1]),
                      !1 === _)
                    )
                      for (
                        ;
          ...
          for (
            ...
            if (
              ...
              (i = l(
                ...
                (me.test(o[0].type) && u(t.parentNode)) || t
              ))
            ) {
  ...
  (ue.find = fe),
    (ue.expr = fe.selectors),
    (ue.expr[":"] = ue.expr.pseudos),
    (ue.uniqueSort = ue.unique = fe.uniqueSort),
    (ue.text = fe.getText),
    (ue.isXMLDoc = fe.isXML),
    (ue.contains = fe.contains),
    (ue.escapeSelector = fe.escape);
  ...
  (ue.filter = function (e, t, n) {
    ...
    ue.fn.extend({
      ...
      is: function (e) {
        return !!s(
          this,
          "string" == typeof e && pe.test(e) ? ue(e) : e || [],
          !1
        ).length;
      },
    });
    ...
    if (((n = n || me), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (
          ...
          ue.merge(
            this,
            ue.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : Y, !0)
          ),
          ge.test(i[1]) && ue.isPlainObject(t))
        )
          for (i in t) oe(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
        return this;
      }
      return (
        (r = Y.getElementById(i[2])) && ((this[0] = r), (this.length = 1)), this
      );
    }
    return e.nodeType
      ...
      function (e, t) {
        ue.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (_e[e] || ue.uniqueSort(r), ye.test(e) && r.reverse()),
            this.pushStack(r)
          );
        };
      }
        ...
        remove: function () {
          return (
            ue.each(arguments, function (e, t) {
              for (var n; (n = ue.inArray(t, s, n)) > -1; )
                s.splice(n, 1), n <= u && u--;
            }),
            this
          );
            ...
            then: function (t, i, r) {
              function o(t, n, i, r) {
                return function () {
                    ...
                    h = r
                      ...
                      : function () {
                          try {
                            ...
                            ue.Deferred.exceptionHook &&
                              ue.Deferred.exceptionHook(e, h.stackTrace),
                              t + 1 >= s &&
                                (i !== c && ((a = void 0), (l = [e])),
                                n.rejectWith(a, l));
                          }
                  ...
                  t
                    ? h()
                    : (ue.Deferred.getStackHook &&
                        (h.stackTrace = ue.Deferred.getStackHook()),
                      e.setTimeout(h));
                };
              }
              var s = 0;
              return ue
                .Deferred(function (e) {
                  n[0][3].add(o(0, e, oe(r) ? r : u, e.notifyWith)),
                    n[1][3].add(o(0, e, oe(t) ? t : u)),
                    n[2][3].add(o(0, e, oe(i) ? i : c));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        var t = arguments.length,
          ...
          s = function (e) {
            return function (n) {
              (i[e] = this),
                (r[e] = arguments.length > 1 ? G.call(arguments) : n),
                --t || o.resolveWith(i, r);
            };
          };
        if (
          ...
          "pending" === o.state() || oe(r[n] && r[n].then))
        )
          return o.then();
  ...
  (ue.fn.ready = function (e) {
    ...
    ue.extend({
      ...
      readyWait: 1,
      ready: function (e) {
        (!0 === e ? --ue.readyWait : ue.isReady) ||
          ((ue.isReady = !0),
          (!0 !== e && --ue.readyWait > 0) || Te.resolveWith(Y, [ue]));
      },
    }),
    (ue.ready.then = Te.then),
    "complete" === Y.readyState ||
    ("loading" !== Y.readyState && !Y.documentElement.doScroll)
      ? e.setTimeout(ue.ready)
    ...
    ue.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((r = Se.get(o)), 1 === o.nodeType && !De.get(o, "hasDataAttrs"))
          ) {
            for (n = s.length; n--; )
              s[n] &&
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!i || Array.isArray(n)
                ? (i = De.access(e, t, ue.makeArray(n)))
                : i.push(n)),
            i || []
          );
      },
  ...
  (ue.event = {
          ...
          n.handler && ((n = (o = n).handler), (r = o.selector)),
            ...
            (s = m.handle) ||
              (s = m.handle = function (t) {
                return void 0 !== ue && ue.event.triggered !== t.type
        ...
        for (u = (t = (t || "").match(be) || [""]).length; u--; )
          if (
            ...
            s &&
              ...
              delete l[d]);
          } else for (d in l) ue.event.remove(e, d + t[u], n, i, !0);
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = ue.event.handlers.call(this, a, u), t = 0;
  ...
  ue.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = E(a), i = 0, r = (o = E(e)).length; i < r; i++) k(o[i], s[i]);
      if (t)
        if (n)
          for (o = o || E(e), s = s || E(a), i = 0, r = o.length; i < r; i++)
            O(o[i], s[i]);
        else O(e, a);
      ...
      for (var t, n, i, r = ue.event.special, o = 0; void 0 !== (n = e[o]); o++)
        if (xe(n)) {
          if ((t = n[De.expando])) {
            if (t.events)
              for (i in t.events)
                r[i] ? ue.event.remove(n, i) : ue.removeEvent(n, i, t.handle);
            n[De.expando] = void 0;
          }
    ...
    ue.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (ue.cleanData(E(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return we(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !Ye.test(e) &&
              !Be[(We.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = ue.htmlPrefilter(e);
              try {
                for (; n < i; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (ue.cleanData(E(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return L(
          ...
          function (t) {
            ...
            ue.inArray(this, e) < 0 &&
              (ue.cleanData(E(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
    ...
    ue.each(
      ...
      function (e, t) {
        ue.fn[e] = function (e) {
          for (var n, i = [], r = ue(e), o = r.length - 1, s = 0; s <= o; s++)
    ...
    function t() {
      if (u) {
        (l.style.cssText =
          ...
          Ue.appendChild(l).appendChild(u);
  ...
  ue.extend({
    ...
    ue.each(["height", "width"], function (e, t) {
      ue.cssHooks[t] = {
        get: function (e, n, i) {
          if (n)
            return !Ze.test(ue.css(e, "display")) ||
  ...
  ue.fn.extend({
    attr: function (e, t) {
      return we(this, ue.attr, e, t, arguments.length > 1);
    },
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ...
            : ((1 === o && ue.isXMLDoc(e)) ||
                (r =
                  ue.attrHooks[t.toLowerCase()] ||
                  (ue.expr.match.bool.test(t) ? ot : void 0)),
              void 0 !== n
                ? null === n
  ...
  ue.fn.extend({
    prop: function (e, t) {
      return we(this, ue.prop, e, t, arguments.length > 1);
    },
    ...
    ue.extend({
      prop: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            (1 === o && ue.isXMLDoc(e)) ||
              ((t = ue.propFix[t] || t), (r = ue.propHooks[t])),
            void 0 !== n
              ? r && "set" in r && void 0 !== (i = r.set(e, n, t))
                ? i
                : (e[t] = n)
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : at.test(e.nodeName) || (lt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function () {
              var t, r, o, s;
              if (i)
                for (r = 0, o = ue(this), s = V(e); (t = s[r++]); )
                  o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = q(this)) && De.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  ue.fn.extend({
    val: function (e) {
      ...
      return arguments.length
        ...
        : r
        ? (t = ue.valHooks[r.type] || ue.valHooks[r.nodeName.toLowerCase()]) &&
          "get" in t &&
    ...
    ue.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, i, r = e.options, o = ue.makeArray(t), s = r.length;
              s--;

            )
              ((i = r[s]).selected =
                ue.inArray(ue.valHooks.option.get(i), o) > -1) && (n = !0);
    ...
    ue.each(["radio", "checkbox"], function () {
      (ue.valHooks[this] = {
        set: function (e, t) {
          if (Array.isArray(t))
            return (e.checked = ue.inArray(ue(e).val(), t) > -1);
        },
      }),
        re.checkOn ||
  ...
  ue.extend(ue.event, {
    trigger: function (t, n, i, r) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !ct.test(p + ue.event.triggered) &&
          (p.indexOf(".") > -1 && ((p = (g = p.split(".")).shift()), g.sort()),
          (u = p.indexOf(":") < 0 && "on" + p),
          (t = t[ue.expando] ? t : new ue.Event(p, "object" == typeof t && t)),
          (t.isTrigger = r ? 2 : 3),
          (t.namespace = g.join(".")),
          ...
          (t.result = void 0),
          t.target || (t.target = i),
          (n = null == n ? [t] : ue.makeArray(n, [t])),
          (f = ue.event.special[p] || {}),
          r || !f.trigger || !1 !== f.trigger.apply(i, n)))
      ) {
        if (!r && !f.noBubble && !se(i)) {
          for (
            l = f.delegateType || p, ct.test(l + p) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            d.push(s), (a = s);
        ...
        return (
          ...
          r ||
            ...
            (u &&
              ...
              t.isPropagationStopped() && h.addEventListener(p, ft),
              i[p](),
              t.isPropagationStopped() && h.removeEventListener(p, ft),
  ...
  (ue.param = function (e, t) {
      ...
      return (
        t ||
          (re.createHTMLDocument
            ? (((i = (t = Y.implementation.createHTMLDocument(
                ""
        ...
        if (this[0]) {
          ...
          if ("fixed" === ue.css(i, "position")) t = i.getBoundingClientRect();
            ...
            e &&
              e !== i &&
              1 === e.nodeType &&
              (((r = ue(e).offset()).top += ue.css(e, "borderTopWidth", !0)),
              (r.left += ue.css(e, "borderLeftWidth", !0)));
          }
          return {
    ...
    ue.each(["top", "left"], function (e, t) {
      ue.cssHooks[t] = H(re.pixelPosition, function (e, n) {
        if (n)
          return (n = j(e, t)), ze.test(n) ? ue(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (ue.noConflict = function (t) {
      return (
        e.$ === ue && (e.$ = vt), t && e.jQuery === ue && (e.jQuery = mt), ue
      );
    }),
    t || (e.jQuery = e.$ = ue),
    ue
  ...
  (function (e, t) {
    ...
    function g(e, n) {
      ...
      return (
        (r ? n.contains(l) : n === l && "BODY" !== l.nodeName) && (g = u(g, n)),
        g
      );
    }
    function m(e) {
    ...
    function P(e, t, n, r) {
      ...
      var o = i(e);
      return (
        L(o, "scroll", n.updateBound, n.scrollParents),
        (n.scrollElement = o),
        (n.eventsEnabled = !0),
        n
      );
      ...
      if ("vh" === s || "vw" === s) {
        return (
          (("vh" === s
            ...
            : G(document.documentElement.clientWidth, window.innerWidth || 0)) /
            100) *
          o
        );
      }
      ...
      fe = (function () {
        function t(n, i) {
          ...
          re(this, t),
            ...
            Object.keys(ae({}, t.Defaults.modifiers, o.modifiers)).forEach(
              function (e) {
                r.options.modifiers[e] = ae(
                  {},
          ...
          arrow: {
            ...
            fn: function (e, n) {
              ...
              var v = l[h] + l[c] / 2 - m / 2,
                ...
                E = v - e.offsets.popper[h] - _ - b;
              return (
                (E = G(Y(a[c] - m, E), 0)),
                (e.arrowElement = r),
                (e.offsets.arrow =
                  ((i = {}), se(i, h, Math.round(E)), se(i, p, ""), i)),
                e
              );
            },
            element: "[x-arrow]",
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              var a,
                ...
                v = I("transform");
              if (
                ((l = "bottom" == g ? -f.height + d.bottom : d.top),
                (a = "right" == m ? -f.width + d.right : d.left),
                u && v)
              )
                ...
                var y = "bottom" == g ? -1 : 1,
                  _ = "right" == m ? -1 : 1;
                (h[g] = l * y), (h[m] = a * _), (h.willChange = g + ", " + m);
              }
              var b = { "x-placement": e.placement };
              return (
                (e.attributes = ae({}, b, e.attributes)),
                (e.styles = ae({}, h, e.styles)),
                (e.arrowStyles = ae({}, e.offsets.arrow, e.arrowStyles)),
                e
              );
            },
            gpuAcceleration: !0,
  ...
  (function (e, t) {
    ...
    var s,
        ...
        (g = (function () {
          ...
          return (
            ...
            (t._removeElement = function (e) {
              var t = this;
              s(e).removeClass(p),
                k.supportsTransitionEnd() && s(e).hasClass(d)
                  ? s(e)
      ...
      P =
        ...
        (O = (function () {
          ...
          return (
            (t.toggle = function () {
                ...
                if (i) {
                  ...
                  if (e) {
                    if (
                      ...
                      return;
                    (i.checked = !m(this._element).hasClass(T)),
                      m(i).trigger("change");
                  }
                  i.focus(), (t = !1);
                }
              ...
              t &&
                this._element.setAttribute(
                  "aria-pressed",
                  !m(this._element).hasClass(T)
                ),
                e && m(this._element).toggleClass(T);
            }),
            (t.dispose = function () {
            ...
            (e._jQueryInterface = function (t) {
              return this.each(function () {
                var n = m(this).data(y);
                n || ((n = new e(this)), m(this).data(y, n)),
                  "toggle" === t && n[t]();
              });
            }),
            r(e, null, [
        ...
        m(document)
          .on(I.CLICK_DATA_API, A, function (e) {
            e.preventDefault();
            var t = e.target;
            m(t).hasClass(w) || (t = m(t).closest(N)),
          ...
          m = (function () {
            ...
            return (
              ...
              (s.show = function () {
                ...
                if (
                  ...
                  if ((e(this._element).trigger(s), !s.isDefaultPrevented())) {
                    ...
                    var l = function () {
                      e(o._element).removeClass(h).addClass(f).addClass(c),
                        (o._element.style[a] = ""),
                  ...
                  if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
                    ...
                    if (
                      ...
                      for (var r = 0; r < this._triggerArray.length; r++) {
                        ...
                        null !== s &&
                          (e(s).hasClass(c) ||
                            e(o).addClass(d).attr("aria-expanded", !1));
                      }
                    this.setTransitioning(!0);
                    var a = function () {
              ...
              (s._getConfig = function (e) {
                return (
                  ((e = o({}, a, e)).toggle = Boolean(e.toggle)),
              ...
              (s._addAriaAndCollapsedClass = function (t, n) {
                if (t) {
                  ...
                  n.length > 0 &&
                    e(n).toggleClass(d, !i).attr("aria-expanded", i);
                }
              }),
            ...
            return (
                  ...
                  if ((a._clearMenus(), !i)) {
                    ...
                    if ((e(t).trigger(o), !o.isDefaultPrevented())) {
                      ...
                      "ontouchstart" in document.documentElement &&
                        ...
                        e(t).toggleClass(h).trigger(e.Event(c.SHOWN, r));
                    }
                  }
                }
              }),
              ...
              (l._getPlacement = function () {
                ...
                return (
                  t.hasClass(d)
                    ? ((n = "top-start"),
                      e(this._menu).hasClass(p) && (n = "top-end"))
                    : t.hasClass("dropright")
                    ? (n = "right-start")
                    : t.hasClass("dropleft")
                    ? (n = "left-start")
                    : e(this._menu).hasClass(p) && (n = "bottom-end"),
                  n
                );
              }),
              ...
              (a._jQueryInterface = function (t) {
                return this.each(function () {
                  ...
                  if (
                    (n ||
                      ((n = new a(this, "object" == typeof t ? t : null)),
                      e(this).data(i, n)),
                    "string" == typeof t)
                  ) {
                    if (void 0 === n[t])
                      ...
                      if (
                        ...
                        e(o).trigger(f),
                          f.isDefaultPrevented() ||
                            ...
                            e(u).removeClass(h),
                            e(o).removeClass(h).trigger(e.Event(c.HIDDEN, l)));
                      }
                    }
                  }
              }),
        ...
        return (
          e(document)
            ...
            .on(c.CLICK_DATA_API, g, function (t) {
              t.preventDefault(),
                t.stopPropagation(),
                _._jQueryInterface.call(e(this), "toggle");
            })
      ...
      W = (function (e) {
            ...
            return (
              ...
              (d.hide = function (t) {
                ...
                if (
                  ...
                  if (
                    ...
                    this._isShown = !1;
                    var r =
                      k.supportsTransitionEnd() && e(this._element).hasClass(c);
              ...
              (d._resetScrollbar = function () {
                e(h.FIXED_CONTENT).each(function (t, n) {
                  ...
                  e(h.STICKY_CONTENT + ", " + h.NAVBAR_TOGGLER).each(function (
                    t,
                    n
                  ) {
              ...
              (i._jQueryInterface = function (n, r) {
                return this.each(function () {
                  ...
                  if (
                    (s || ((s = new i(this, a)), e(this).data(t, s)),
                    "string" == typeof n)
                  ) {
                    if (void 0 === s[n])
        ...
        return (
          e(document).on(l.CLICK_DATA_API, h.DATA_TOGGLE, function (n) {
            var i,
              r = this,
            ...
            return (
              ...
              (_.show = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                  ...
                  k.supportsTransitionEnd() && e(this.tip).hasClass(g)
                    ? e(this.tip)
                        .one(k.TRANSITION_END, f)
              ...
              (_.hide = function (t) {
                ...
                e(this.element).trigger(r),
                  r.isDefaultPrevented() ||
                    ...
                    k.supportsTransitionEnd() && e(this.tip).hasClass(g)
                      ? e(i).one(k.TRANSITION_END, o).emulateTransitionEnd(150)
                      : o(),
                    (this._hoverState = ""));
              }),
              (_.update = function () {
              ...
              (_._enter = function (t, n) {
                ...
                (n = n || e(t.currentTarget).data(i)) ||
                  ...
                  e(n.getTipElement()).hasClass(m) || n._hoverState === h
                    ? (n._hoverState = h)
      ...
      B = (function (e) {
        var t = "popover",
          ...
          f = (function (o) {
            ...
            var f, h;
            (h = o),
              ((f = s).prototype = Object.create(h.prototype)),
            ...
            return (
              ...
              (d._getConfig = function (n) {
                if ("string" != typeof (n = o({}, a, n)).target) {
                  ...
                  i || ((i = k.getUID(t)), e(n.target).attr("id", i)),
                    (n.target = "#" + i);
                }
              ...
              (d._activate = function (t) {
                ...
                i.hasClass("dropdown-item")
                  ? (i.closest(f.DROPDOWN).find(f.DROPDOWN_TOGGLE).addClass(c),
                    i.addClass(c))
                  : (i.addClass(c),
                    i
          ...
          c = (function () {
            ...
            return (
              (i.show = function () {
                ...
                if (
                  ...
                  var f = e.Event(o.HIDE, { relatedTarget: this._element }),
                    h = e.Event(o.SHOW, { relatedTarget: i });
                  if (
                    (i && e(i).trigger(f),
              ...
              (i._activate = function (t, n, i) {
                ...
                o && s
                  ? e(o).one(k.TRANSITION_END, a).emulateTransitionEnd(150)
                  : a();
              }),
              (i._transitionComplete = function (t, n, i) {
                ...
                if (
                  ...
                  o && e(o).find(".dropdown-toggle").addClass(s),
